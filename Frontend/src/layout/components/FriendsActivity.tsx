...
const FriendsActivity = () => {
    ...
    return (<>
        ...
        <div className="h-screen bg-zinc-900 rounded-lg flex flex-col">
            <div className="p-4 flex justify-between items-center border-b border-t-zinc-800">
